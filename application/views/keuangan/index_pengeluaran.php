            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div style="float:right;"> 
                        <a href="<?php echo $url.'/add';?>" class="btn btn-icon btn-outline-primary btn-sm" data-toggle="tooltip" data-original-title="Tambah Pengeluaran"> <i class="feather icon-plus"></i> Tambah</a> 
                    </div>
                </div>
